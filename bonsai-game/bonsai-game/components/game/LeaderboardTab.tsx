          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                <th style={{ textAlign: "right", padding: "6px 4px", fontSize: 9, color: "#555", fontWeight: 700, letterSpacing: 1 }}>ROOMS</th>
                <th style={{ textAlign: "right", padding: "6px 4px", fontSize: 9, color: "#555", fontWeight: 700, letterSpacing: 1 }}>HARVESTS</th>
              </tr>
            </thead>
            <tbody>
              {leaderboard.slice(0, 50).map((entry, i) => {
                ...
                return (
                  <tr key={i} style={{ borderBottom: "1px solid rgba(255,255,255,0.03)" }}>
                    ...
                    <td style={{ padding: "8px 4px", fontSize: 12, color: "#8BC34A", fontWeight: 700, textAlign: "right", fontVariantNumeric: "tabular-nums" }}>{formatCash(entry.cash)}</td>
                    <td style={{ padding: "8px 4px", fontSize: 11, color: "#666", textAlign: "right" }}>{entry.rooms}</td>
                    <td style={{ padding: "8px 4px", fontSize: 11, color: "#666", textAlign: "right" }}>{entry.harvests}</td>
                  </tr>
                );
              })}
            </tbody>
